package by.it.doNotTouch.bunkov.jd02_03;
...
class Dispatcher {
    ...
    private static BlockingQueue<Backet> baskets = new ArrayBlockingQueue<>(50);
    ...
    public static Backet getBacket() throws InterruptedException {
        return baskets.take();
    }
    ...
    public static void putBasket(Backet basket) {
        try {
            basket.clear();
            baskets.put(basket);
        } catch (InterruptedException e) {
