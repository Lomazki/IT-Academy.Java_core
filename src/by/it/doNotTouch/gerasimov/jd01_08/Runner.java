package by.it.doNotTouch.gerasimov.jd01_08;
...
class Runner {
    ...
    private static void print4(Var v1, Var v2) {
        System.out.println(v1 + " + " + v2 + " = " + v1.add(v2));
        System.out.println(v1 + " - " + v2 + " = " + v1.sub(v2));
        System.out.println(v1 + " * " + v2 + " = " + v1.mul(v2));
        System.out.println(v1 + " / " + v2 + " = " + v1.div(v2));
    }

    private static void printAll(Var v1, Var v2) {
        print4(v1, v2);
        print4(v2, v1);
    }
