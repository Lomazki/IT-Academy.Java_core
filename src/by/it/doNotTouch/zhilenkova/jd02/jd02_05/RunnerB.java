package by.it.doNotTouch.zhilenkova.jd02.jd02_05;
...
public class RunnerB {
    public static void main(String[] args) {
        ...
        if (args.length >= 2) {
            ...
            resourceBundle = ResourceBundle.getBundle("by.it.zhilenkova.jd02.jd02_05.MyResources", locale);
            dateFormat = DateFormat.getDateInstance(DateFormat.FULL, locale);
            dateToString = dateFormat.format(date);
        } else {
            Locale.setDefault(new Locale("en", "EN"));
            resourceBundle = ResourceBundle.getBundle("by.it.zhilenkova.jd02.jd02_05.MyResources", Locale.getDefault());
